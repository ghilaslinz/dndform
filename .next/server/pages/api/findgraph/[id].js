...
module.exports = __webpack_require__("8SYu");
...
/* harmony import */ var _mongoose_models_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("l73j");
/* harmony import */ var _mongoose_models_form__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_mongoose_models_form__WEBPACK_IMPORTED_MODULE_2__);
...
const getit = async (label, id) => {
  const ss = await _mongoose_models_graph__WEBPACK_IMPORTED_MODULE_1___default.a.find({
    formId: id,
    ques: label
  }).exec();
  return ss;
...
const handlegraphshape = async id => {
  const data = await _mongoose_models_form__WEBPACK_IMPORTED_MODULE_2___default.a.find({
    _id: id
  }).exec();
  return data;
};
