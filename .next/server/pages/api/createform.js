...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  switch (method) {
    case "POST":
      try {
        const newform = await new _mongoose_models_form__WEBPACK_IMPORTED_MODULE_1___default.a({
          _id: new mongoose__WEBPACK_IMPORTED_MODULE_2___default.a.Types.ObjectId(),
          tools: req.body
        });
...
module.exports = __webpack_require__("/eR+");
